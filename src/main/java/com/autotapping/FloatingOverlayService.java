...
public class FloatingOverlayService extends Service {
    ...
    private void startForegroundWithNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setDescription("Crosshair and settings overlay");
        ...
        Notification notification = new Notification.Builder(this, CHANNEL_ID)
                .setContentTitle("auto-tapping-android active")
                .setContentText("Drag the crosshair to the target point")
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_OUTSIDE:
                    // Ignore outside touches while auto-tapping — they are
                    // generated by our own dispatchGesture() calls, not by the user.
    ...
    private void updateCoordsLabel() {
        if (menuVisible && menuView != null) {
            ...
            if (tv != null) {
                tv.setText("Target: X " + crosshairParams.x + "  Y " + crosshairParams.y);
            }
        }
    }
